    ...
    public function getConfig(Request $request): JsonResponse
    {
        ...
        $configPayload = [
            ...
            'data' => [
                ...
                'call_recharge_teaser_text' => $config['call_recharge_teaser_text'] ?? 'Recharge coins now to enjoy uninterrupted HD calls',
                'call_top_badge_text' => $config['call_top_badge_text'] ?? 'Official Verified Host',
                'call_quick_messages' => $config['call_quick_messages'] ?? ['Hi handsome 💋', 'Can you hear me?', 'Show me your face ✨', 'Sending you love ❤️'],
