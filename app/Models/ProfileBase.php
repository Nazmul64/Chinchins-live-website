    ...
    public static function seedDefaultBases(): void
    {
        $defaultBases = [
            [
                ...
                'required_coins'   => 0,
                'base_frame_image' => 'uploads/bases/profile_base_novice_cadet.png',
                'badge_icon'       => 'user',
                'badge_color'      => '#94a3b8',
            ...
            [
                ...
                'required_coins'   => 1000,
                'base_frame_image' => 'uploads/bases/profile_base_bronze_star.png',
                'badge_icon'       => 'star',
                'badge_color'      => '#10b981',
            ...
            [
                ...
                'required_coins'   => 5000,
                'base_frame_image' => 'uploads/bases/profile_base_dollar_ring.png',
                'badge_icon'       => 'dollar-sign',
                'badge_color'      => '#10b981',
                'glow_color'       => 'rgba(16, 185, 129, 0.55)',
                'privilege_text'   => 'Unlocks Dollar Ring Rich Gold Frame & Coin Glow',
                'is_active'        => true,
                'sort_order'       => 2,
            ],
            [
                ...
                'base_frame_image' => 'uploads/bases/profile_base_circus_gentleman.png',
                'badge_icon'       => 'gem',
                'badge_color'      => '#f59e0b',
                'glow_color'       => 'rgba(245, 158, 11, 0.5)',
                'privilege_text'   => 'Unlocks Circus Gentleman Gold Hat & Rich Banner Frame',
                'is_active'        => true,
                'sort_order'       => 3,
            ],
            [
                ...
                'base_frame_image' => 'uploads/bases/profile_base_top3_spotlight.png',
                'badge_icon'       => 'crown',
                'badge_color'      => '#a855f7',
                'glow_color'       => 'rgba(168, 85, 247, 0.7)',
                'privilege_text'   => 'Unlocks TOP 3 Purple Stage Spotlight Avatar Frame',
                'is_active'        => true,
                'sort_order'       => 4,
            ],
            [
                ...
                'base_frame_image' => 'uploads/bases/profile_base_blue_captain.png',
                'badge_icon'       => 'compass',
                'badge_color'      => '#00f0ff',
                'glow_color'       => 'rgba(0, 240, 255, 0.6)',
                'privilege_text'   => 'Unlocks Blue Captain Steering Wheel & Anchor Neon Frame',
                'is_active'        => true,
                'sort_order'       => 5,
            ],
            [
                ...
                'base_frame_image' => 'uploads/bases/profile_base_devil_horns.png',
                'badge_icon'       => 'fire',
                'badge_color'      => '#ef4444',
                'glow_color'       => 'rgba(239, 68, 68, 0.65)',
                'privilege_text'   => 'Unlocks Flaming Devil Horns & Red Ruby Frame',
                'is_active'        => true,
                'sort_order'       => 6,
            ],
            [
                ...
                'base_frame_image' => 'uploads/bases/profile_base_cricket_superstar.png',
                'badge_icon'       => 'trophy',
                'badge_color'      => '#eab308',
                'glow_color'       => 'rgba(234, 179, 8, 0.65)',
                'privilege_text'   => 'Unlocks Cricket Superstar Gold Helmet, Bat & Ball Frame',
                'is_active'        => true,
                'sort_order'       => 7,
            ],
            [
                ...
                'base_frame_image' => 'uploads/bases/profile_base_cyber_speedometer.png',
                'badge_icon'       => 'bolt',
                'badge_color'      => '#38bdf8',
                'glow_color'       => 'rgba(56, 189, 248, 0.7)',
                'privilege_text'   => 'Unlocks Cyber Speedometer Cyan Shield & Neon Aura',
                'is_active'        => true,
                'sort_order'       => 8,
            ],
            [
                ...
                'base_frame_image' => 'uploads/bases/profile_base_rose_garden.png',
                'badge_icon'       => 'heart',
                'badge_color'      => '#f43f5e',
                'glow_color'       => 'rgba(244, 63, 94, 0.75)',
                'privilege_text'   => 'Unlocks Blooming Pink Roses Crown & Golden Heart Locket',
                'is_active'        => true,
                'sort_order'       => 9,
            ],
            [
                ...
                'base_frame_image' => 'uploads/bases/profile_base_queen_imperial.png',
                'badge_icon'       => 'crown',
                'badge_color'      => '#ec4899',
            ...
            [
                ...
                'base_frame_image' => 'uploads/bases/profile_base_king_royal.png',
                'badge_icon'       => 'crown',
                'badge_color'      => '#f59e0b',
            ...
            [
                ...
                'base_frame_image' => 'uploads/bases/profile_base_superbike_rider.png',
                'badge_icon'       => 'bolt',
                'badge_color'      => '#6366f1',
            ...
            [
                ...
                'base_frame_image' => 'uploads/bases/profile_base_phoenix_immortal.png',
                'badge_icon'       => 'fire',
                'badge_color'      => '#f97316',
            ...
            [
                ...
                'base_frame_image' => 'uploads/bases/profile_base_ocean_poseidon.png',
                'badge_icon'       => 'water',
                'badge_color'      => '#06b6d4',
            ...
            [
                ...
                'base_frame_image' => 'uploads/bases/profile_base_supreme_sovereign.png',
                'badge_icon'       => 'crown',
                'badge_color'      => '#ffd700',
