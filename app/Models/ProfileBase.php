...
class ProfileBase extends Model
{
    ...
    public static function seedDefaultBases(): void
    {
        $defaultBases = [
            ...
            [
                'level'            => 7,
                'name'             => 'Level 7 - TOP 3 Stage Spotlight Base',
            ...
            [
                'level'            => 8,
                'name'             => 'Level 8 - Diamond Wings Sovereign',
                'required_coins'   => 1000000,
                'base_frame_image' => 'uploads/bases/profile_base_diamond_wings.svg',
                'badge_icon'       => 'crown',
                'badge_color'      => '#38bdf8',
                'glow_color'       => 'rgba(56, 189, 248, 0.7)',
                'privilege_text'   => 'Unlocks Celestial Diamond Wings Avatar Frame & VIP Aura',
                'is_active'        => true,
                'sort_order'       => 8,
            ],
            [
                'level'            => 9,
                'name'             => 'Level 9 - QUEEN Imperial Diamond Wings',
                'required_coins'   => 2500000,
                'base_frame_image' => 'uploads/bases/profile_base_queen_imperial.svg',
                'badge_icon'       => 'crown',
                'badge_color'      => '#ec4899',
                'glow_color'       => 'rgba(236, 72, 153, 0.8)',
                'privilege_text'   => 'Unlocks QUEEN Imperial Diamond Crown & Angel Wings Base',
                'is_active'        => true,
                'sort_order'       => 9,
            ],
            [
                'level'            => 10,
                'name'             => 'Level 10 - KING Golden Royal Winged Crown',
            ...
            [
                'level'            => 11,
                'name'             => 'Level 11 - Galaxy Galactic Emperor',
                'required_coins'   => 8000000,
                'base_frame_image' => 'uploads/bases/profile_base_galactic_emperor.svg',
                'badge_icon'       => 'globe',
                'badge_color'      => '#c084fc',
                'glow_color'       => 'rgba(192, 132, 252, 0.85)',
                'privilege_text'   => 'Unlocks Cosmic Galactic Purple Wings & Star Portal Frame',
                'is_active'        => true,
                'sort_order'       => 11,
            ],
            [
                'level'            => 12,
                'name'             => 'Level 12 - Fire Phoenix Immortal',
            ...
            [
                'level'            => 14,
                'name'             => 'Level 14 - Cyber Mecha Overlord',
                'required_coins'   => 25000000,
                'base_frame_image' => 'uploads/bases/profile_base_cyber_overlord.svg',
                'badge_icon'       => 'bolt',
                'badge_color'      => '#22d3ee',
                'glow_color'       => 'rgba(34, 211, 238, 0.9)',
                'privilege_text'   => 'Unlocks Cyber Mecha Neon Laser Halo & Cyber Visor Frame',
                'is_active'        => true,
                'sort_order'       => 14,
            ],
            [
