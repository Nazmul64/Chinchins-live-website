...
// Clear gifts table and re-seed with every single item in every single category
...
echo "Total Gifts Seeded: " . Gift::count() . "\n";
$summary = Gift::select('category', DB::raw('count(*) as cnt'))->groupBy('category')->get();
foreach ($summary as $s) {
    echo " - " . strtoupper($s->category) . ": " . $s->cnt . " items\n";
}
